          ...
          <Stack flexDirection="row">
            ...
            <Stack flex={4} gap={4}>
              <Stack>
                ...
                >
                  A collection of 6 NFTs that enhance user roles and value in
                  our native app Portals. By owning a card you can augment
                  features, open hidden worlds, increase earnings, unlock
                  discounts, and gain access.
                </Typography>
              </Stack>
              <Typography
                variant="subtitle2"
...
const cards = [
  ...
  },
  {
    ...
    bid: 0.001,
    img: "/images/micro.png",
    spec: ["Increase earnings by 5%", "20% discount on 3D models"],
  },
  {
    title: "Mega",
    price: 2.45,
