            ...
            <Stack flexDirection="row">
              ...
              <Stack flex={4} gap={4}>
                <Stack>
                  ...
                  >
                    Matter provides a minimal and unobrusive interface that lets
                    you focus on what matters most; your clients experience. We
                    give you gesture based controls and touch placement so you
                    can design and deploy on the go.
                  </Typography>
                </Stack>
                <Typography
                  variant="subtitle2"
        ...
        <Stack flexDirection={matchUpMd ? "row" : "column"} gap={10}>
          ...
          >
            ...
            >
              ...
              <li>
                <Typography color="text.secondary" variant="subtitle2">
                  Export to Matter and place items from our marketplace to
                  enhance your scene
                </Typography>
              </li>
              <li>
          ...
          >
            <Box component="img" src="/images/matter-half.png" />
          </Stack>
        </Stack>
      </Stack>
    </Box>
