                  ...
                  >
                    ...
                    <Stack flexDirection="row" alignItems="center" gap={2}>
                      <Typography
                        ...
                        sx={{
                          background:
                            "linear-gradient(270deg, #5035FF 30.47%, #00A3FF 100%)",
                          backgroundClip: "text",
              ...
              <Stack flexDirection="row">
                ...
                <Stack flex={4} gap={4}>
                  <Stack>
                    ...
                    >
                      H3M Portals combine AR beacon technology with real-time
                      KPI’s to help help creators track and maximize the
                      conversion process in real time so you can engage your
                      audience with the content they need the moment they need
                      it.
                    </Typography>
                  </Stack>
                  <Typography
...
const phones = [
  {
    title: "Manage",
    content:
      "Use our wallet to get further utility out of your collection of NFT’s, cards, and rewards.",
    img: "/images/phone-1.png",
  },
  {
    title: "Collect",
    content:
      "Collect NFT’s, beacons, artifacts and a range of branded products and rewards",
    img: "/images/phone-2.png",
  },
  {
    title: "Grow",
    content:
      "Use our wallet app to stake your HMMM token and earn 36% APY from your staked balance.",
