          ...
          <Stack flexDirection="row">
            ...
            <Stack flex={4} gap={4}>
              <Stack>
                ...
                >
                  When you own virtual land, you can rent that space to artists
                  and creators who want to host a unique experience. Disneyland,
                  how about leasing out space near your Star Wars zone, so users
                  can promote AR projects and Jedi Force related virtual games?
                </Typography>
              </Stack>
              <Typography
                variant="subtitle2"
          ...
          >
              ...
              >
                ...
                >
                  <Typography variant="h3" color="background.default">
                    Virtual Worlds More Revenue
                  </Typography>
                  <Typography variant="body2" color="text.secondary">
                    Build your virtual empire by collecting locations around the
                    world. Host, curate, flip, trade or sell locations and grow
                    your enterprise.
                  </Typography>
                </Stack>
            ...
            >
              ...
              >
                ...
                >
                  <Typography variant="h3" color="background.default">
                    Make money from your experiences.
                  </Typography>
                  <Typography variant="body2" color="text.secondary">
                    When curators place an experience on you virtual property
                    you willrecieve a percentage of transactions that occur
                    along with the fee to book your location.
                  </Typography>
                </Stack>
                <Stack
                  flexDirection="row"
...
const cards = [
  {
    ...
    price: "1",
    content:
      "Login to Domain with your wallet and discover vacant land to purchase.",
  },
  {
    title: "Purchase",
    price: "2",
